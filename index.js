...
function get20s(arr,string){
  ...
  for(let i = 0; i = arr.length; i++){
    if(arr[i].includes({string})){
      artistNames.push(arr[i])
      }
    }
    return artistNames
  }

console.log(get20s(artists, '1907'))
...
function addArtist(arr,id,name,years,genre,nation,bio){
    arr.push({id,name,years,genre,nation,bio})
    return arr
  }

  // console.log(addArtist(artists, '22', 'Joel Vega', '1997-now','Web Design', 'American', 'Something Somthing artsy artsy'))
